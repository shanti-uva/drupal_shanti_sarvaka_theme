...
function shanti_sarvaka_carousel($variables) {
  ...
  foreach($el['slides'] as $n => $slide) {
    ...
    $html .= '<!-- Slide' . $n . ' -->
      <div class="item ' . $active . '">
        <div class="carousel-main-content col-xs-7 col-md-8 col-lg-9">
          <div><h3 class="carousel-title"><a href="' . $slide['path'] . '"><i class="icon shanticon-stack"></i> ' . $slide['title'] . '</a></h3></div>
        ...
        <div class="carousel-main-image col-xs-5 col-md-4 col-lg-3">
  ...
  $html .= '</div>
              <div class="control-box">
                  <a data-slide="prev" href="#collection-carousel" class="carousel-control left basebg"><span class="icon"></span></a>
                  <a data-slide="next" href="#collection-carousel" class="carousel-control right basebg"><span class="icon"></span></a>
              </div><!-- /.control-box -->
