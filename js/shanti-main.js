   ...
   attach: function (context, settings) {
      if (context == document) {
          ...
          Drupal.ShantiSarvaka.sidebarFooterGravity = function() {   
              ...
              var mainwrapper_minimum_adminfooter = (height) - 370;
              ...
              var sidebarsecond = (mainwrapper) - 70;  // for sidebar height - adds 20px to sidebar-second in AV height for top-margin/padding
