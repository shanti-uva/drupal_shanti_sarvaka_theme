    ...
    win.ichecked = function() {
      ...
      var operate = function(node, parent, key, method, silent, before, ajax) {
        ...
        if (method == 'updated' || method == 'click') {
        	// Change made by ndg8f (UVA) for Shanti Sarvaka theme because checkboxes not working properly
        	//   Adding || method = 'click' to conditional (2015-02-27)
          changes.checked = (before || method == 'click') ? !states.checked[0] : states.checked[0];
